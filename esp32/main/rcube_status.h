 ...
 *   - 그룹번호(01~99)를 10진 두 자리로 분해: 십의자리=첫색(0.5s), 일의자리=둘째색(1.0s).
 *     자리색: 0Red 1Green 2Blue 3Cyan 4Magenta 5Yellow 6Violet 7Orange
 *             8=연한Red(0의 1/2 밝기) 9=연한Green(1의 1/2 밝기).
 *     패턴: 첫색 0.5s ON → 0.5s OFF → 둘째색 1.0s ON → 0.5s OFF … 반복.
 *   - 그룹번호 0(공장초기, 전체가 0)일 때만 예외로 흰색으로 같은 타이밍 점멸.
 *
